...
## Agricultural data (Ghana) {#agricultural-data-(ghana)}
...
## Climate data (Kenya) {#climate-data-(kenya)}
...
## Data journalism (Mexico) {#data-journalism-(mexico)}
...
## Defence data (France) {#defence-data-(france)}
...
## Financial data (South Africa) {#financial-data-(south-africa)}
...
## Government data (Croatia) {#government-data-(croatia)}
...
## Heritage data (Cambodia) {#heritage-data-(cambodia)}
...
## Library data (India) {#library-data-(india)}
