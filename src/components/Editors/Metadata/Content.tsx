    ...
    <Stack spacing={3} sx={{ padding: 3, height: '100%' }}>
      <Stack direction="row" spacing={3} height="100%">
        <CardButton
          ...
          onClick={() => updateEditorState({ type: 'package' })}
        />
        <CardButton
          label="Resource"
          ...
          onClick={() => updateEditorState({ type: 'resource' })}
        />
      </Stack>
      <Stack direction="row" spacing={3} height="100%">
        <CardButton
          ...
          onClick={() => updateEditorState({ type: 'dialect' })}
        />
        <CardButton
          label="Schema"
          ...
          onClick={() => updateEditorState({ type: 'schema' })}
        />
      </Stack>
    </Stack>
  )
